...
//ImageView img_list, img_grid;
    ...
    Context cntx;
    JSONArray six_month_json;
    String strType;
    MembershipInterface mCallback;
    public SixMonthsFragment(Context context, JSONArray jsonArraySixMonths, String strFrom) {
        // Required empty public constructor
        cntx = context;
        six_month_json=jsonArraySixMonths;
        strType=strFrom;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sixMonthMembership(six_month_json);
        return v;
    }

    private void sixMonthMembership(JSONArray threeMonthJsonArray) {
        try {
