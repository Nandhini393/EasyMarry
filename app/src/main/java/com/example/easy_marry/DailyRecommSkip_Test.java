 ...
 */
public class DailyRecommSkip_Test extends Activity {
    TextView txt_span;
...
img_back=(ImageView)findViewById(R.id.menu);
        ...
        ll_go_matches.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DailyRecommSkip_Test.this, Matches.class));
                finish();
            }
        });
   ...
   /* final Handler someHandler = new Handler(getMainLooper());
    ...
    /* final Handler someHandler = new Handler(getMainLooper());
      ...
      DailyRecommSkip_Test.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(DailyRecommSkip_Test.this, "Hii**", Toast.LENGTH_SHORT).show();
                Calendar calander = Calendar.getInstance();
                SimpleDateFormat simpleDateFormat = new SimpleDateFormat("HH:mm:ss");
                String time = simpleDateFormat.format(calander.getTime());
                String [] current_time=time.split(":");
