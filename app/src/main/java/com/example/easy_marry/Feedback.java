...
public class Feedback extends Activity implements View.OnClickListener {
    ImageView img_back;
    EditText et_get_feedback;
    Button btn_feedback;
    TextView txt_chat_now;
    Button btn_rate;
   ...
   // ImageView img_edit_my_profile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_get_feedback=(EditText)findViewById(R.id.et_feedback);
        btn_feedback=(Button)findViewById(R.id.btn_feedback);
        txt_chat_now=(TextView)findViewById(R.id.txt_chat_now);
...
//your matches
        ...
        btn_feedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isConnected) {
                if(et_get_feedback.getText().toString().length()==0){
        ...
        txt_chat_now.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Feedback.this,ChatNow.class));
            }
        });
       ...
       /* img_edit_my_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Feedback.this,EditProfile.class));
            }
        });*/
        ll_my_profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i= new Intent(Feedback.this,DailyRecomViewProfie.class);
        ...
        txt_terms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity( new Intent(Feedback.this, TermsAndConditions.class));
            }
        });
...
*/
        ...
        btn_rate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(str_rate.equalsIgnoreCase("0")){
                    ...
                    btn_rate_now.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if(ratingBar.getRating()==0){
                                Toast.makeText(Feedback.this, "Please enter the rating star", Toast.LENGTH_SHORT).show();
                            }
                            else{
                    ...
                    Toast.makeText(Feedback.this, "You have already rated...", Toast.LENGTH_SHORT).show();
                }
        ...
        if (vv instanceof LinearLayout) {
            ...
            imV.setBackgroundResource(R.drawable.feed_back_orange);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.my_matches:
                ...
                startActivity(new Intent(Feedback.this, Matches.class));
            ...
            case R.id.mail_box:
                ...
                startActivity(new Intent(Feedback.this, MailboxNewTabs.class));
                img_dailyrecom_grey.setBackgroundResource(R.drawable.daily_recom_grey);
                txt_dailyrecom.setTextColor(Color.GRAY);
            ...
            case R.id.daily_recom:
                ...
                Intent i= new Intent(Feedback.this,DailyRecommList.class);
            ...
            case R.id.upgrade_acc:
                ...
                startActivity(new Intent(Feedback.this, MembershipTabs.class));
                img_settings_grey.setBackgroundResource(R.drawable.settings_grey);
                txt_settings.setTextColor(Color.GRAY);
            ...
            case R.id.search:
                ...
                startActivity(new Intent(Feedback.this, QuickSearch.class));
            ...
            case R.id.add_horo:
                ...
                startActivity(new Intent(Feedback.this, AddHoroscope.class));
    ...
    public void feedBackCall(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GeneralData.LOCAL_IP+"feedback.php",
                        ...
                        try {
                            ...
                            if (jsobj.getString("status").equalsIgnoreCase("success")) {
                               ...
                               View itemView1 = LayoutInflater.from(ctx)
                                ...
                                String str_span="Your feedback has been sent";
                                SpannableString spannableString = new SpannableString(str_span);
                                spannableString.setSpan(new ForegroundColorSpan(Color.parseColor("#fb7b09")), 4, 13, 0);
...
//username=sathish@ansjad.com&password=testing
                ...
                params.put("message", et_get_feedback.getText().toString().trim());
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Log.i("HH", "strResp : " + response);
                            if (jsobj.getString("status").equalsIgnoreCase("success")) {
                                Toast.makeText(Feedback.this, "Thanks for rating our app", Toast.LENGTH_SHORT).show();
                                str_rate=str_rating;
