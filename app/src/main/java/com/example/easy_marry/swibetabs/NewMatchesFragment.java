...
public class NewMatchesFragment extends Fragment {
   ...
   RecyclerAdapter mAdapter;
    ...
    GeneralData gD;
    String str_new_matches_int="empty";

    public NewMatchesFragment(String user_id, Context ctx, String strFrom) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.e("NH:", "new matches-->"+Matches.internet_con);
        ...
        ((Matches)getActivity()).setFragmentRefreshListener(new Matches.FragmentRefreshListener() {
            ...
            public void onRefresh() {
                ...
                matchesListCall();
                NewMatchesFragment.mySwipeRefresh.setRefreshing(false);
    ...
    public void matchesListCall() {
        //matches rest call
        gD.showAlertDialog(context,"Loading","please wait...");
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GeneralData.LOCAL_IP + "newmatches.php",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsobj.getString("status").equalsIgnoreCase("success")) {
                                ...
                                //mCallback.get_matches("","","new matches","",null);
