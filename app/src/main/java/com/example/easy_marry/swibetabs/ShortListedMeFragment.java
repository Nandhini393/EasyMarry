 ...
 */
public class ShortListedMeFragment extends Fragment {
...
TextView txt_list_error;
    GeneralData gD;
    public ShortListedMeFragment(String user_id, Context ctx, String strFrom) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txt_list_error=(TextView)v.findViewById(R.id.txt_tab_error_msg) ;
        Log.e("NH:", "shorlist_me-->"+Matches.internet_con);
        ((Matches)getActivity()).setFragmentRefreshListener(new Matches.FragmentRefreshListener() {
            @Override
            public void onRefresh() {

                matchesListCall();
                ShortListedMeFragment.mySwipeRefresh.setRefreshing(false);
        ...
        if(Matches.internet_con.equalsIgnoreCase("yes")){
            ...
            matchesListCall();
            ShortListedMeFragment.mySwipeRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                @Override
                public void onRefresh() {
                    matchesListCall();
    ...
    public void matchesListCall() {
        //matches rest call
        gD.showAlertDialog(context,"Loading","Please wait...");
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GeneralData.LOCAL_IP + "shortlistedme.php",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsobj.getString("status").equalsIgnoreCase("success")) {
                                ...
                                gD.altDialog.dismiss();
                            txt_list_error.setText("Your profile is yet to be shortlisted.");
                                rl_matches_list.setVisibility(View.GONE);
