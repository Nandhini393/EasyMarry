 ...
 */
public class SentFragment extends android.support.v4.app.Fragment {
//ImageView img_list, img_grid;
    ...
    public SentFragment(String str_userid,Context con,String str_type) {
        // Required empty public constructor
        context=con;
    ...
    public void sentBoxListCall() {
        //matches rest call
        final ProgressDialog loading = ProgressDialog.show(context, "Loading", "Please wait...", false, false);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GeneralData.LOCAL_IP + "sentbox.php",
                            ...
                            if (jsobj.getString("status").equalsIgnoreCase("success")) {
                                ...
                                if (json_matched_profile.length() > 0) {
                                    for (int i = 0; i < json_matched_profile.length(); i++) {
                                        ...
                                        drawerBean.setStr_mail_id(matchesJSONObj.getString("sentboxid"));
                                        drawerBean.setStr_mail_type(matchesJSONObj.getString("type"));
                                        drawerBean.setStr_date_time(matchesJSONObj.getString("sendtime"));
                                ...
                                txt_mail_error.setText("Your sentbox is empty....");
