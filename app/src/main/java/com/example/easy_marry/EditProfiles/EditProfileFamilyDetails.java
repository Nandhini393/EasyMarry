 ...
 */
public class EditProfileFamilyDetails extends Activity implements MyInterface {
    Button btn_basic_det_save;
    ImageView img_back;
    View itemView1;
    Context context;
    EditText et_family_type, et_family_status, et_family_values, et_father_occ, et_mother_occ, et_search_profile_for;
    String str_fam_val_id = "", str_fam_type_id = "", str_fam_stat_id = "", str_father_occup_id = "", str_mother_occup_id = "", str_user_id = "";
    ListDrawerAdapter listDrawerAdapter;
    ListView listView;
    DrawerLayout myDrawerLayout;
    LinearLayout myLinearLayout;
    JSONArray json_fam_val, json_fam_type, json_fam_status, json_father_occup, json_mother_occup;
    String str_family_details_json, str_response_partner;
    GeneralData gD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.edit_profile_family_details);
        context = this;
        gD = new GeneralData(context);
        str_user_id = gD.prefs.getString("userid", null);
        str_family_details_json = getIntent().getStringExtra("json_edit_family_details");
        Log.e("NN:edit_basic", str_family_details_json);
        ...
        et_family_type = (EditText) findViewById(R.id.et_family_type);
        et_family_status = (EditText) findViewById(R.id.et_family_status);
        et_family_values = (EditText) findViewById(R.id.et_family_values);
        et_father_occ = (EditText) findViewById(R.id.et_father_occ);
        et_mother_occ = (EditText) findViewById(R.id.et_mother_occ);
        ...
        et_father_occ.setFocusable(false);
        et_mother_occ.setFocusable(false);

        img_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(EditProfileFamilyDetails.this,EditProfile.class));
                finish();
            }
        });
                ...
                if (isConnected) {
                    ...
                    et_search_profile_for.addTextChangedListener(new TextWatcher() {
                        ...
                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                            ...
                            listDrawerAdapter = new ListDrawerAdapter(context, filteredList, (MyInterface) context, "family_values");
                    ...
                    Toast.makeText(EditProfileFamilyDetails.this, "No response from server", Toast.LENGTH_LONG).show();
            ...
            public void onClick(View v) {
                ...
                et_search_profile_for.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        ...
                        listDrawerAdapter = new ListDrawerAdapter(context, filteredList, (MyInterface) context, "family_type");
                        listView.setVisibility(View.VISIBLE);
                        listView.setAdapter(listDrawerAdapter);
                        listDrawerAdapter.notifyDataSetChanged(); // data set changed
                    }
            ...
            public void onClick(View v) {
                ...
                et_search_profile_for.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        ...
                        listDrawerAdapter = new ListDrawerAdapter(context, filteredList, (MyInterface) context, "family_status");
                        listView.setVisibility(View.VISIBLE);
                        listView.setAdapter(listDrawerAdapter);
                        listDrawerAdapter.notifyDataSetChanged(); // data set changed
                    }
            ...
            public void onClick(View v) {
                ...
                et_search_profile_for.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        ...
                        listDrawerAdapter = new ListDrawerAdapter(context, filteredList, (MyInterface) context, "father_occup");
                        listView.setVisibility(View.VISIBLE);
                        listView.setAdapter(listDrawerAdapter);
                        listDrawerAdapter.notifyDataSetChanged(); // data set changed
                    }
            ...
            public void onClick(View v) {
                ...
                et_search_profile_for.addTextChangedListener(new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        ...
                        listDrawerAdapter = new ListDrawerAdapter(context, filteredList, (MyInterface) context, "mother_occup");
                        listView.setVisibility(View.VISIBLE);
                        listView.setAdapter(listDrawerAdapter);
                        listDrawerAdapter.notifyDataSetChanged(); // data set changed
                    }
    ...
    public void getEditBasicDetCall(String str_basic_json, String str_response) {
        ...
        try {
            ...
            JSONObject myFamDetJsonObj = new JSONObject(str_basic_json);


            String fam_val = myFamDetJsonObj.getString("Family Values");
            for (int i = 0; i < json_fam_val.length(); i++) {
                if (fam_val.equals(json_fam_val.getJSONObject(i).getString("value"))) {
                    str_fam_val_id = json_fam_val.getJSONObject(i).getString("id");
                    break;
                }
            }
            String fam_type = myFamDetJsonObj.getString("Family Type");
            for (int i = 0; i < json_fam_type.length(); i++) {
                if (fam_type.equals(json_fam_type.getJSONObject(i).getString("value"))) {
                    str_fam_type_id = json_fam_type.getJSONObject(i).getString("id");
                    break;
                }
            }
            String fam_status = myFamDetJsonObj.getString("Family Status");
            for (int i = 0; i < json_fam_status.length(); i++) {
                if (fam_status.equals(json_fam_status.getJSONObject(i).getString("value"))) {
                    str_fam_stat_id = json_fam_status.getJSONObject(i).getString("id");
                    break;
                }
            }

          /*  if(str_response.equalsIgnoreCase("partner"))
            {
                et_father_occ.setVisibility(View.GONE);
                et_mother_occ.setVisibility(View.GONE);
            }
            else
            {*/

            String father_occ = myFamDetJsonObj.getString("Father Occupation");
            for (int i = 0; i < json_father_occup.length(); i++) {
                if (father_occ.equals(json_father_occup.getJSONObject(i).getString("value"))) {
                    str_father_occup_id = json_father_occup.getJSONObject(i).getString("id");
                    break;
                }
            }

            String mother_occ = myFamDetJsonObj.getString("Mother Occupation");
            for (int i = 0; i < json_mother_occup.length(); i++) {
                if (mother_occ.equals(json_mother_occup.getJSONObject(i).getString("value"))) {
                    str_mother_occup_id = json_mother_occup.getJSONObject(i).getString("id");
                    break;
                }
            }
            et_father_occ.setText(father_occ);
            et_mother_occ.setText(mother_occ);
            // }

            et_family_values.setText(fam_val);
            et_family_type.setText(fam_type);
            et_family_status.setText(fam_status);
    ...
    public void updateUserFamilyDet() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GeneralData.LOCAL_IP + "edit_user5.php",
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsobj.getString("status").equalsIgnoreCase("success")) {
                                ...
                                altDialog.setView(itemView1);
                                altDialog.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
                                String str_span = "Your family details have been updated successfully";
                                TextView txt_span_text = (TextView) itemView1.findViewById(R.id.span_text);
                                Button btn_ok = (Button) itemView1.findViewById(R.id.btn_ok);
                                SpannableString spannableString1 = new SpannableString(str_span);
                                spannableString1.setSpan(new ForegroundColorSpan(Color.parseColor("#639639")), 4, 19, 0);
...
//3Secs
        RequestQueue requestQueue = Volley.newRequestQueue(EditProfileFamilyDetails.this);
    ...
    public void updatePartnerFamilyDet() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, GeneralData.LOCAL_IP + "edit_partner5.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsobj.getString("status").equalsIgnoreCase("success")) {
                                ...
                                altDialog.setView(itemView1);
                                altDialog.getWindow().setBackgroundDrawableResource(android.R.color.transparent);
                                String str_span = "Your partner family details have been updated successfully";
                                TextView txt_span_text = (TextView) itemView1.findViewById(R.id.span_text);
                                Button btn_ok = (Button) itemView1.findViewById(R.id.btn_ok);
                                SpannableString spannableString1 = new SpannableString(str_span);
                                spannableString1.setSpan(new ForegroundColorSpan(Color.parseColor("#639639")), 4, 27, 0);
                                txt_span_text.setText(spannableString1);
                                btn_ok.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
...
// returned data is not JSONObject?
            ...
            protected Map<String, String> getParams() {
                ...
                if (str_fam_val_id.length() > 0) {
                    params.put("partnerfamilyvalue", str_fam_val_id);
                }
                if (str_fam_type_id.length() > 0) {
                    params.put("partnerfamilytype", str_fam_type_id);
                }
                if (str_fam_stat_id.length() > 0) {
                    params.put("partnerfamilystatus", str_fam_stat_id);
                }
                if (str_father_occup_id.length() > 0) {
                    params.put("partnerfatheroccupation", str_father_occup_id);
                }
                if (str_mother_occup_id.length() > 0) {
                    params.put("partnermotheroccupation", str_mother_occup_id);
                }
                if (str_user_id.length() > 0) {
                    params.put("userid", str_user_id);
                }
...
//3Secs
    ...
    public void get_list_drawer_items(String str_items, String str_items_id, String strIdentify, HashMap<String, JSONObject> str_json_obj) {
        ...
        if (strIdentify.equalsIgnoreCase("family_values")) {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (jsobj.getString("status").equalsIgnoreCase("success")) {
                                        ...
                                        JSONArray json_array_fam_type = jsobj.getJSONArray("family type");
                                        ...
                                        getEditBasicDetCall(str_family_details_json, str_response_partner);
                                        for (int i = 0; i < json_array_fam_type.length(); i++) {

                                            ListDrawerBean drawerBean = new ListDrawerBean();
                                            JSONObject providersServiceJSONobject = json_array_fam_type.getJSONObject(i);
                                        ...
                                        listDrawerAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, "family type");
                                        listView.setVisibility(View.VISIBLE);
                                        listView.setAdapter(listDrawerAdapter);
