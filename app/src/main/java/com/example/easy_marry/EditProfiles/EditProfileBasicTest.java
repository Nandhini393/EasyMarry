...
import com.example.easy_marry.Adapter.ListDrawerPartnerAdapter;
 ...
 */
public class EditProfileBasicTest extends Activity implements MyInterface {
    Button btn_basic_det_save;
    ImageView img_back;
    View itemView1;
    Context context;
    EditText et_search_profile_for, et_search_partner,et_age, et_name, et_height, et_weight,
    ...
    ListDrawerPartnerAdapter listDrawerPartnerAdapter;
    ListDrawerAdapter listDrawerUserAdapter;
    ListView listView;
    ...
    RelativeLayout rl_list_user, rl_list_partner;
    ImageView img_drawer_tick, img_drawer_close;
    String str_RemoveVal;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rl_list_user = (RelativeLayout) findViewById(R.id.rl_list_user);
        img_drawer_tick = (ImageView) findViewById(R.id.filter_tick2);
        img_drawer_close = (ImageView) findViewById(R.id.filter_cancel2);
        rl_list_partner = (RelativeLayout) findViewById(R.id.rl_list_partner);
        ...
        et_search_partner=(EditText)findViewById(R.id.et_filter_search2);
        ...
        img_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(EditProfileBasicTest.this, EditProfile.class));
                finish();
            }
        });
                ...
                if (isConnected) {
                    if (str_from.equalsIgnoreCase("user")) {
                        ...
                        if (str_name.length() == 0) {
                            Toast.makeText(EditProfileBasicTest.this, "Enter name", Toast.LENGTH_SHORT).show();
                        } else if (et_height.getText().toString().trim().equalsIgnoreCase("-select-")) {
                            Toast.makeText(EditProfileBasicTest.this, "Select height", Toast.LENGTH_SHORT).show();
                        } else if (et_weight.getText().toString().trim().equalsIgnoreCase("-select-")) {
                            Toast.makeText(EditProfileBasicTest.this, "Select weight", Toast.LENGTH_SHORT).show();
                        } else if (et_marital_stat.getText().toString().trim().equalsIgnoreCase("-select-")) {
                            Toast.makeText(EditProfileBasicTest.this, "Select marital status", Toast.LENGTH_SHORT).show();
                        } else if (et_mother_ton.getText().toString().trim().equalsIgnoreCase("-select-")) {
                            Toast.makeText(EditProfileBasicTest.this, "Select mother tongue", Toast.LENGTH_SHORT).show();
                        } else if (et_phy_stat.getText().toString().trim().equalsIgnoreCase("-select-")) {
                            Toast.makeText(EditProfileBasicTest.this, "Select physical status", Toast.LENGTH_SHORT).show();
                        } else if (et_body_type.getText().toString().trim().equalsIgnoreCase("-select-")) {
                            Toast.makeText(EditProfileBasicTest.this, "Select body type", Toast.LENGTH_SHORT).show();
                        } else if (et_profile_create.getText().toString().trim().equalsIgnoreCase("-select-")) {
                            Toast.makeText(EditProfileBasicTest.this, "Select profile created for", Toast.LENGTH_SHORT).show();
                        } else {
                            updateUserBasicDet();
                        }
        ...
        if (myDrawerLayout != null && myDrawerLayout instanceof DrawerLayout) {
        ...
        et_height.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isConnected) {
                    if (str_from.equalsIgnoreCase("user")) {
                        rl_list_user.setVisibility(View.VISIBLE);
                        rl_list_partner.setVisibility(View.GONE);
                    } else if (str_from.equalsIgnoreCase("partner")) {
                        rl_list_user.setVisibility(View.GONE);
                        rl_list_partner.setVisibility(View.VISIBLE);
                    }
                    ...
                    et_search_profile_for.addTextChangedListener(new TextWatcher() {
                        ...
                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                            ...
                            if (str_from.equalsIgnoreCase("user")) {
                                ...
                                listDrawerUserAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, "height");
                                listView.setVisibility(View.VISIBLE);
                                listView.setAdapter(listDrawerUserAdapter);
                                listDrawerUserAdapter.notifyDataSetChanged();
                            } else if (str_from.equalsIgnoreCase("partner")) {
                                listDrawerPartnerAdapter = new ListDrawerPartnerAdapter(context, filteredList, (MyInterface) context, "", "checkbox");
                                listView.setVisibility(View.VISIBLE);
                                listView.setAdapter(listDrawerPartnerAdapter);
                                listDrawerPartnerAdapter.notifyDataSetChanged(); // data set changed
                            }
                    ...
                    Toast.makeText(EditProfileBasicTest.this, "No response from server", Toast.LENGTH_LONG).show();
                    ...
                    et_search_profile_for.addTextChangedListener(new TextWatcher() {
                        ...
                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                            ...
                            if (str_from.equalsIgnoreCase("user")) {
                                ...
                                listDrawerUserAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, "age");
                                listView.setVisibility(View.VISIBLE);
                                listView.setAdapter(listDrawerUserAdapter);
                                listDrawerUserAdapter.notifyDataSetChanged();
                            } else if (str_from.equalsIgnoreCase("partner")) {
                    ...
                    et_search_profile_for.addTextChangedListener(new TextWatcher() {
                        ...
                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                            ...
                            if (str_from.equalsIgnoreCase("user")) {
                                ...
                                listDrawerUserAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, "weight");
                                listView.setVisibility(View.VISIBLE);
                                listView.setAdapter(listDrawerUserAdapter);
                                listDrawerUserAdapter.notifyDataSetChanged();
                            } else if (str_from.equalsIgnoreCase("partner")) {
                    ...
                    et_search_profile_for.addTextChangedListener(new TextWatcher() {
                        ...
                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                            ...
                            if (str_from.equalsIgnoreCase("user")) {
                                ...
                                listDrawerUserAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, "physical_status");
                                listView.setVisibility(View.VISIBLE);
                                listView.setAdapter(listDrawerUserAdapter);
                                listDrawerUserAdapter.notifyDataSetChanged();
                            } else if (str_from.equalsIgnoreCase("partner")) {
                    ...
                    et_search_profile_for.addTextChangedListener(new TextWatcher() {
                        ...
                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                            ...
                            if (str_from.equalsIgnoreCase("user")) {
                                ...
                                listDrawerUserAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, "body_type");
                                listView.setVisibility(View.VISIBLE);
                                listView.setAdapter(listDrawerUserAdapter);
                                listDrawerUserAdapter.notifyDataSetChanged();
                            } else if (str_from.equalsIgnoreCase("partner")) {
            ...
            public void onClick(View v) {
                ...
                if (isConnected) {
                    ...
                    if (str_from.equalsIgnoreCase("user")) {
                        ...
                        et_search_profile_for.addTextChangedListener(new TextWatcher() {
                            ...
                            public void onTextChanged(CharSequence s, int start, int before, int count) {
                                ...
                                for (int i = 0; i < beanArrayList.size(); i++) {
                                    ...
                                    listDrawerUserAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, "mothertongue");
                                    listView.setVisibility(View.VISIBLE);
                                    listView.setAdapter(listDrawerUserAdapter);
                                    listDrawerUserAdapter.notifyDataSetChanged();
                        ...
                        str_mother_ton_id = gD.prefs.getString("mother_ton_id", null);
                        et_mother_ton.setText(gD.prefs.getString("mother_ton", null));
                        et_search_partner.setText("");
                        rl_list_user.setVisibility(View.GONE);
                        rl_list_partner.setVisibility(View.VISIBLE);

                        Log.i("NAN", "str_mother_ton_id : " + str_mother_ton_id);
                        Log.i("NAN", "text_mother : " + et_mother_ton.getText().toString().trim());

                     if (et_mother_ton.getText().toString().trim().length() > 0)
                        {
                            LoadLayout_Edit(json_mother_ton,"",str_mother_ton_id, "");

                        }
                        et_search_partner.addTextChangedListener(new TextWatcher() {
                            @Override
                            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                    ...
                    et_search_profile_for.addTextChangedListener(new TextWatcher() {
                        ...
                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                            ...
                            if (str_from.equalsIgnoreCase("user")) {
                                ...
                                listDrawerUserAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, "marital_status");
                                listView.setVisibility(View.VISIBLE);
                                listView.setAdapter(listDrawerUserAdapter);
                                listDrawerUserAdapter.notifyDataSetChanged();
                            } else if (str_from.equalsIgnoreCase("partner")) {
                    ...
                    et_search_profile_for.addTextChangedListener(new TextWatcher() {
                        ...
                        public void onTextChanged(CharSequence s, int start, int before, int count) {
                            ...
                            if (str_from.equalsIgnoreCase("user")) {
                                ...
                                listDrawerUserAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, "profile");
                                listView.setVisibility(View.VISIBLE);
                                listView.setAdapter(listDrawerUserAdapter);
                                listDrawerUserAdapter.notifyDataSetChanged();
                            } else if (str_from.equalsIgnoreCase("partner")) {
        ...
        img_drawer_tick.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences.Editor prefEdit = gD.prefs.edit();
                isOpen = false;
                if (!hsFilterGmap.isEmpty()) {
                    ...
                    if (hsFilterGmap != null) {
                        ...
                        if (val.contains(",")) {
                            ...
                            et_mother_ton.setText(val);
                        Log.e("Na", "mother_ton id-->" + id);
                        Log.e("Na", "mother_ton val-->" + val);


                        prefEdit.putString("mother_ton", val);
                        prefEdit.putString("mother_ton_id", id);
...
//        return new DatePickerDialog(this, myDateListener, year, month, day);
    ...
    private ArrayList<ListDrawerBean> LoadLayout(JSONArray providerServicesMonth, String stridentifyEdit) {
        ...
        try {
            ...
            if (str_from.equalsIgnoreCase("user")) {
                ...
                listDrawerUserAdapter = new ListDrawerAdapter(context, beanArrayList, (MyInterface) context, stridentifyEdit);
                listView.setVisibility(View.VISIBLE);
                listView.setAdapter(listDrawerUserAdapter);
                listDrawerUserAdapter.notifyDataSetChanged();
            } else if (str_from.equalsIgnoreCase("partner")) {
                listDrawerPartnerAdapter = new ListDrawerPartnerAdapter(context, beanArrayList, (MyInterface) context, "", "checkbox");
                listView.setVisibility(View.VISIBLE);
                listView.setAdapter(listDrawerPartnerAdapter);
                listDrawerPartnerAdapter.notifyDataSetChanged(); // data set changed
            }
    ...
    private ArrayList<ListDrawerBean> LoadLayout_Edit(JSONArray providerServicesMonth, String str_from_click, String StrVariable, String strSpinFrom) {
        ...
        try {
            ...
            listDrawerPartnerAdapter = new ListDrawerPartnerAdapter(context, beanArrayList, (MyInterface) context,"edit","checkbox", StrVariable);
            listView.setVisibility(View.VISIBLE);
            listView.setAdapter(listDrawerPartnerAdapter);
            listDrawerPartnerAdapter.notifyDataSetChanged(); // data set changed
...
//3Secs
        RequestQueue requestQueue = Volley.newRequestQueue(EditProfileBasicTest.this);
                            ...
                            public void onResponse(String response) {
                             ...
                             /*   str_profile_for_id = profile_created_by.getJSONObject(0).getString("id");
                                ...
                                str_mother_tonngue_id = jsonArray_mother_tongue.getJSONObject(0).getString("id");*/
                                        ...
                                        listView.setVisibility(View.VISIBLE);
                                        listView.setAdapter(listDrawerPartnerAdapter);
                                        //listDrawerPartnerAdapter.notifyDataSetChanged();
                                    }
